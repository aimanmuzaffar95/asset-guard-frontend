                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-[var(--border-soft)]">
                        {mockAssignments.map((assignment) => (
                            <tr key={assignment.id} className="group hover:bg-[var(--surface-muted)] transition-colors">
                                ...
                                <td className="py-4 pr-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-[var(--text-interactive)]">
                                            {assignment.staffName}
                                        </span>
                                    </div>
                                </td>
                                <td className="py-4 pr-4 text-sm text-[var(--text-muted)]">
                                    {assignment.date}
                                </td>
                                <td className="py-4">
                                    <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${assignment.status === "Assigned" ? "bg-emerald-500/10 text-emerald-600" :
